...
public abstract class BShopJSONFeedActivity extends AppCompatActivity {
...
//        GeolocationUtils.checkCountryAndShowDialog(this);
        ...
        Admob.loadInterstitialAds(BShopJSONFeedActivity.this);
            ...
            public void onClick(View view) {
                new Admob(new onDismiss() {
                    ...
                    public void onDismiss() {
                        ...
                        Intent i = new Intent(BShopJSONFeedActivity.this, ViewerActivity.class);
...
//                        StartAppAd.showAd(getBaseContext());
                ...
                }).ShowInterstitial(BShopJSONFeedActivity.this, true);
            }
    ...
    private void showNoInternet () {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View p1) {
                ...
                //dialog.dismiss();
                Intent i = new Intent(BShopJSONFeedActivity.this, SplashActivity.class);
                startActivity(i);
            }
        });
    }
