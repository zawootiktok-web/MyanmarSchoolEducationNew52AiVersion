...
import com.mmschooledu.QandAnswer.NewKnoledgeActivity;
import com.mmschooledu.R;
import com.mmschooledu.TGuideIndexActivity;

import java.util.ArrayList;
import java.util.List;

public abstract class DictionaryIndexActivity extends AppCompatActivity

{
    ...
    private BroadcastReceiver messageStatusReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (show) {
                ...
                Toast.makeText(DictionaryIndexActivity.this, message, Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.index_main_dictionary);
       // GeolocationUtils.checkCountryAndShowDialog(this);


        Admob.loadInterstitialAds(DictionaryIndexActivity.this);
//        Admob.loadRewordedAds(DictionaryIndexActivity.this);
        Admob.loadRewardedInterstitialAds(DictionaryIndexActivity.this);
    ...
    public class FeedAdapter extends RecyclerView.Adapter<FeedAdapter.ViewHolder>
    {
        ...
        {
            View v=getLayoutInflater().inflate(R.layout.dictionarytype_item,p1,false);
                ...
                if (position == 0) {
                    ...
                    new Admob(new onDismiss() {
                        ...
                        public void onDismiss() {
                            Intent i = new Intent(DictionaryIndexActivity.this, NewDictionaryActivity.class);
                  ...
                  //  StartAppAd.showAd(getBaseContext());
                    ...
                    new Admob(new onDismiss() {
                        @Override
                        public void onDismiss() {
                    Intent i = new Intent(DictionaryIndexActivity.this, NewDictionaryActivity2.class);
                  ...
                  //  StartAppAd.showAd(getBaseContext());
                    ...
                    new Admob(new onDismiss() {
                        @Override
                        public void onDismiss() {
                            Intent i = new Intent(DictionaryIndexActivity.this, NewProverbsActivity.class);
                    ...
                    new Admob(new onDismiss() {
                        @Override
                        public void onDismiss() {
                            Intent i = new Intent(DictionaryIndexActivity.this, NewKnoledgeActivity.class);
                            String title = "အထွေထွေဗဟုသုတများ";
                            CategoryItem pi = filteredposts.get(getAdapterPosition());
...
//                        public void onDismiss() {
                    Intent i = new Intent(DictionaryIndexActivity.this, NewKnoledgeActivity.class);
                    String title = "AI နှင့် နည်းပညာ အသုံးပြုနည်းများ";
                    CategoryItem pi = filteredposts.get(getAdapterPosition());
    ...
    private void changeFont()
    {
        ...
        try{
           ...
           // Toast.makeText(this,e.toString(),Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(DictionaryIndexActivity.this,
