...
public abstract class ProverbsJSONFeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Admob.loadInterstitialAds(ProverbsJSONFeedActivity.this);
//        Admob.loadRewordedAds(ProverbsJSONFeedActivity.this);
        Admob.loadRewardedInterstitialAds(ProverbsJSONFeedActivity.this);
...
//                        // When Ads Close Take Action
                    ...
                    if (audienceNetwork.isLoaded()) {
                        ...
                        audienceNetwork.show(new AudienceNetwork.Dismissed() {
                            ...
                            public void onclick() {
                                ...
                                launchProverbsActivityCategories();
                            }
                        });
                    } else {
            ...
            private void launchProverbsActivityCategories() {


                        Intent i = new Intent(ProverbsJSONFeedActivity.this, ProverbsActivityCategories.class);
...
//                }).ShowInterstitial(ProverbsJSONFeedActivity.this, true);
//            }
