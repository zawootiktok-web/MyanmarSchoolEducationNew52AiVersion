...
public abstract class TGuideIndexActivity extends AppCompatActivity
    ...
    private BroadcastReceiver messageStatusReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (show) {
                ...
                Toast.makeText(TGuideIndexActivity.this, message, Toast.LENGTH_SHORT).show();
            }
        }
    };
...
//                startActivity(i);
            ...
            private void hideAds() {
                ...
                //Toast.makeText(TGuideIndexActivity.this, " Lucky Day No Ads for you", Toast.LENGTH_SHORT).show();
            }
        });
...
// SDK Initialize
        Admob.loadInterstitialAds(TGuideIndexActivity.this);
//        Admob.loadRewordedAds(TGuideIndexActivity.this);
        imageview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View _view) {
                ...
                Intent i=new Intent(TGuideIndexActivity.this,BookShopActivity.class);
                startActivity(i);
                    }
                }).ShowInterstitial(TGuideIndexActivity.this, true);
            };});
...
//                    public void onDismiss() {
            ...
            private void launchNewBookActivity() {
                Intent i=new Intent(TGuideIndexActivity.this,NewBookActivity.class);
...
//            }
    ...
    private void changeFont()
    {
        ...
        try{
          ...
          //  Toast.makeText(this,e.toString(),Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(TGuideIndexActivity.this,
    ...
    private void showNoInternet (){
        ...
        button.setOnClickListener(new View.OnClickListener(){
            ...
            {
//                dialog.dismiss();
                Intent i = new Intent(TGuideIndexActivity.this, SplashActivity.class);
                startActivity(i);
            }});
    }}
