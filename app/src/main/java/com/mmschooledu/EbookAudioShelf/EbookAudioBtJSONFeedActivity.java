...
public abstract class EbookAudioBtJSONFeedActivity extends AppCompatActivity
{private InterstitialAd interstitial;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
		...
		title=getIntent().getExtras()
			.get("title").toString();
		AudioIndex=getIntent().getExtras()
			.get("AudioIndex").toString();
	...
	public class FeedAdapter extends RecyclerView.Adapter<FeedAdapter.ViewHolder>
	{
		...
		public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
		{
			...
			public void onClick(View view)
			{
				...
				Intent i=new Intent(EbookAudioBtJSONFeedActivity.this,EbookAudioBookActivity.class);
