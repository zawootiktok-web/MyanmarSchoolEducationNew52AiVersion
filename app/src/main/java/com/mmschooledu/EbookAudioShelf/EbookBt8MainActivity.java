...
public class EbookBt8MainActivity extends EbookJSONFeedActivity
{
	...
	String[] links={
		"https://onlinebookstoreaudiobook.blogspot.com/feeds/posts/default/-/Lesson2?alt=json&start-index=1&max-results=150",
		"https://onlinebookstoreaudiobook.blogspot.com/feeds/posts/default/-/Lesson2?alt=json&start-index=150&max-results=300",
		"https://onlinebookstoreaudiobook.blogspot.com/feeds/posts/default/-/Lesson2?alt=json&start-index=300&max-results=450",
		"https://onlinebookstoreaudiobook.blogspot.com/feeds/posts/default/-/Lesson2?alt=json&start-index=450&max-results=600",
