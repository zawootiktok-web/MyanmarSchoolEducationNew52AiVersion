...
public abstract class EbookAudiofeedActivity extends AppCompatActivity
{
...
//       interstitial = new InterstitialAd(EbookAudiofeedActivity.this) {
//            @Nullable
//            @Override
            ...
            p1.card.setOnClickListener(new OnClickListener(){
                    ...
                    public void onClick(View p1) {
                        if(isOnline()){
                            ...
                            Intent i=new Intent(EbookAudiofeedActivity.this,EbookAudioPlayer.class);    //    EbookDetailActivity2 
