...
public abstract class EbookIndexActivity extends AppCompatActivity

{
	...
	public class FeedAdapter extends RecyclerView.Adapter<FeedAdapter.ViewHolder>
	{
		...
		public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
		{
			...
			//	Intent i=new Intent(EbookIndexActivity.this,VideoActivity.class);
				...
				Intent i=new Intent(EbookIndexActivity.this,EbookBookActivityCategories.class);
	...
	private void showNoInternet (){
		...
		tv_title.setText("No internet connection!Please open your internet ");
