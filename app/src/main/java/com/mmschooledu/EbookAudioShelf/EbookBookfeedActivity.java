...
public abstract class EbookBookfeedActivity extends AppCompatActivity
{
                    ...
                    public void onClick(View p1) {
                        if(isOnline()){
                         ...
                         /*   if(itemClick==3){
                            ...
                            Intent i=new Intent(EbookBookfeedActivity.this,EbookPdfDetailActivity.class);    //    EbookDetailActivity2 
