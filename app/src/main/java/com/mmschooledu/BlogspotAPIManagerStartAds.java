...
public class BlogspotAPIManagerStartAds {

    private static final String TAG = "BlogspotAPIManagerStartAds";
    private static final String BLOGSPOT_JSON_URL = "https://myanmarschooleducationads.blogspot.com/feeds/posts/default?alt=json";

    private Context context;
    private RequestQueue requestQueue;

    public BlogspotAPIManagerStartAds(Context context) {
