...
//    }
    ...
    public void refresh(){
        ...
        if(isOnline()){
            online=true;
            new VideoIndexActivity.DownloadTask().execute(link);
        }else{
            online=false;
            Toast.makeText(getApplicationContext(),"No internet connection",Toast.LENGTH_SHORT).show();
            ...
            try{
                ...
                adapter=new VideoIndexActivity.FeedAdapter();
    ...
    {
        getMenuInflater().inflate(R.menu.main_menuaudio,menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if(item.getItemId()==R.id.menu_font){
            ...
            Intent i=new Intent(VideoIndexActivity.this, VideoMainActivity.class);
            startActivity(i);
            //refresh();
        }
...
//                        // When Ads Close Take Action
            ...
            private void launchNewVideoActivity() {
                        Intent i=new Intent(VideoIndexActivity.this, NewVideoActivity.class);
...
//                }).ShowInterstitial(VideoIndexActivity.this, true);
//            }
