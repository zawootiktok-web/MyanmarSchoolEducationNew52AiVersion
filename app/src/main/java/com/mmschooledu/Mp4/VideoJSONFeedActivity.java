...
import com.mmschooledu.Mp3.Mp3JSONFeedActivity;
...
public abstract class VideoJSONFeedActivity extends AppCompatActivity
{
    ...
    private BroadcastReceiver messageStatusReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (show) {
                ...
                Toast.makeText(VideoJSONFeedActivity.this, message, Toast.LENGTH_SHORT).show();
            }
        }
    };
...
//                startActivity(i);
            ...
            private void hideAds() {
                ...
                Toast.makeText(VideoJSONFeedActivity.this, " Lucky Day No Ads for you", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        getMenuInflater().inflate(R.menu.main_menuvideo,menu);
    ...
    public class FeedAdapter extends RecyclerView.Adapter<FeedAdapter.ViewHolder>
    {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
        {
            ...
            public void onClick(View view)
            {
                ...
                Intent i=new Intent(VideoJSONFeedActivity.this, VideoViewerActivity.class);
        ...
        }).ShowInterstitial(VideoJSONFeedActivity.this, true);
