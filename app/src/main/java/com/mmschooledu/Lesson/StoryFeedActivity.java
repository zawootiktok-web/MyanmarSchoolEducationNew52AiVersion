...
public abstract class StoryFeedActivity extends AppCompatActivity
{
...
//        adView.loadAd(adRequest);
    ...
    {
        getMenuInflater().inflate(R.menu.storymain_menu,menu);
...
//                    public void onDismiss() {
            ...
            private void launchViewerActivity() {
                        ...
                        Intent i=new Intent(StoryFeedActivity.this, ViewerActivity.class);
...
//                }).ShowInterstitial(StoryFeedActivity.this, true);
//            }
    ...
    private void showNoInternet() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View p1) {
                //dialog.dismiss();
                Intent i = new Intent(StoryFeedActivity.this, SplashActivity.class);
                startActivity(i);
            }});
    }}
