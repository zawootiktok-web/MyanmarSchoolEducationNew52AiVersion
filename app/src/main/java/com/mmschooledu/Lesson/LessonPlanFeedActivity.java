...
public abstract class LessonPlanFeedActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //  com.bdtopcoder.quickadmob.Admob.loadInterstitialAds(JSONFeedActivity1.this);
    ...
    {
        getMenuInflater().inflate(R.menu.lplanmain_menu,menu);
    ...
    public class FeedAdapter extends RecyclerView.Adapter<FeedAdapter.ViewHolder>
    {
        ...
        {
            if((!filteredposts.get(p2).thumbnailUrl.isEmpty())&&(online)){
                Glide
...
//                    public void onDismiss() {
                    ...
                    private void launchViewerActivity() {
                        ...
                        Intent i=new Intent(LessonPlanFeedActivity.this, ViewerActivity.class);
...
//                }).ShowInterstitial(LessonPlanFeedActivity.this, true);
//            }
    ...
    private void showNoInternet() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View p1) {
                //dialog.dismiss();
                Intent i = new Intent(LessonPlanFeedActivity.this, SplashActivity.class);
                startActivity(i);
            }});
    }}
