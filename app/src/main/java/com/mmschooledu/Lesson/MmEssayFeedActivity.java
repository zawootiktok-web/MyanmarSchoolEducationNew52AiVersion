...
public abstract class MmEssayFeedActivity extends AppCompatActivity
...
//        adView.loadAd(adRequest);
    ...
    {
        getMenuInflater().inflate(R.menu.mmessaymain_menu,menu);
...
//                    public void onDismiss() {
            ...
            private void launchViewerActivity() {
                        ...
                        Intent i=new Intent(MmEssayFeedActivity.this, ViewerActivity.class);
...
//                }).ShowInterstitial(MmEssayFeedActivity.this, true);
//            }
    ...
    private void showNoInternet() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View p1) {
                //dialog.dismiss();
                Intent i = new Intent(MmEssayFeedActivity.this, SplashActivity.class);
                startActivity(i);
            }});
    }}
