...
public abstract class KnowledgeFeedActivity extends AppCompatActivity
{
...
//                });
    ...
    {
        getMenuInflater().inflate(R.menu.main_menuknowledge,menu);
...
//                    public void onDismiss() {
            ...
            private void launchViewerActivity() {
                Intent i=new Intent(KnowledgeFeedActivity.this, ViewerActivity.class);
...
//        }).ShowInterstitial(KnowledgeFeedActivity.this, true);
//    }
    ...
    private void showNoInternet() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View p1) {
                //dialog.dismiss();
                Intent i = new Intent(KnowledgeFeedActivity.this, SplashActivity.class);
                startActivity(i);
            }});
    }}
