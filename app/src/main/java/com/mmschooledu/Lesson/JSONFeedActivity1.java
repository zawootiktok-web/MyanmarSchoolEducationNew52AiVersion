...
import com.mmschooledu.BookfeedActivity;
...
public abstract class JSONFeedActivity1 extends AppCompatActivity
{
    ...
    private BroadcastReceiver messageStatusReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (show) {
                ...
                Toast.makeText(JSONFeedActivity1.this, message, Toast.LENGTH_SHORT).show();
            }
        }
    };
...
//                startActivity(i);
            ...
            private void hideAds() {
                ...
                Toast.makeText(JSONFeedActivity1.this, " Lucky Day No Ads for you", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    {
        getMenuInflater().inflate(R.menu.main_menunew,menu);
...
//                    public void onDismiss() {
            ...
            private void launchViewerActivity() {
                Intent i=new Intent(JSONFeedActivity1.this, ViewerActivity.class);
...
//            }).ShowInterstitial(JSONFeedActivity1.this, true);
//        }
    ...
    private void showNoInternet() {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View p1) {
                //dialog.dismiss();
                Intent i = new Intent(JSONFeedActivity1.this, SplashActivity.class);
                startActivity(i);
            }});
    }}
