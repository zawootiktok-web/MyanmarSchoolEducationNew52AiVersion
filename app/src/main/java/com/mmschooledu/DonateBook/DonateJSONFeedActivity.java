...
public abstract class DonateJSONFeedActivity extends AppCompatActivity
{
	//private InterstitialAd interstitialAd;
	private String TAG = "DonateJSONFeedActivity";
	...
	RecyclerView rv;
	FeedAdapter adapter;
	List<DonatePostItem> posts,filteredposts;
	boolean online=true;
	Toolbar tb;
	String currentLink="";
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.donatejsonfeed_layout);

		tb=(Toolbar)findViewById(R.id.nnl_toolbar);
		setSupportActionBar(tb);
		getSupportActionBar().setDisplayHomeAsUpEnabled(true);
		setTitle("စာ​ကြည့်တိုက်တွင်လှူထား​​သောစာအုပ်များ");
		...
		filteredposts=new ArrayList<DonatePostItem>();
	...
	public void addItem(DonatePostItem item){
		posts.add(item);
	}
	...
	public class FeedAdapter extends RecyclerView.Adapter<FeedAdapter.ViewHolder>
	{
		...
		{
			View v=getLayoutInflater().inflate(R.layout.donateitem_layout,p1,false);//donateitem_layout
		...
		public DonatePostItem getItem(int pos){
		...
		public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
		{
			...
			public void onClick(View view)
			{
				...
				Intent i=new Intent(DonateJSONFeedActivity.this, DBookActivityCategories.class);


				DonatePostItem pi=filteredposts.get(getAdapterPosition());
			...
			//}
				...
				}).ShowInterstitial(DonateJSONFeedActivity.this, true);
			}
