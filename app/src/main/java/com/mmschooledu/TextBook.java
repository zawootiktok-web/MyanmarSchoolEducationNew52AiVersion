...
public class TextBook extends TextIndexActivity
{
    ...
    public void processJson(String inputJson){
        ...
        try
        {
            ...
            for(int i=0;i<ja.length();i++){
                ...
                if(jo2.getJSONObject("title").getString("$t").equals("Textbook Index")){
...
//            Toast.makeText(TextBook.this,
//                    "\"Warning\" Internet is slow \n Use phone sim card internet without wifi \n or " +
//                            "\n Swipe the phone screen by hand to refresh", Toast.LENGTH_LONG).show();
            showNoInternet();
        }
    ...
    public String getFeedAddress()
    {
        ...
        return "https://textbookandquestion.blogspot.com/feeds/posts/default?alt=json";
    }
