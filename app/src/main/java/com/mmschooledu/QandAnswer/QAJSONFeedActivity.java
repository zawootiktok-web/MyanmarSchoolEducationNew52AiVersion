...
public abstract class QAJSONFeedActivity extends AppCompatActivity
{//String link;
	//String link;
	...
	private BroadcastReceiver messageStatusReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (show) {
				...
				Toast.makeText(QAJSONFeedActivity.this, message, Toast.LENGTH_SHORT).show();
			}
		}
	};
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		Admob.loadInterstitialAds(QAJSONFeedActivity.this);
//		Admob.loadRewordedAds(QAJSONFeedActivity.this);
...
//                startActivity(i);
			...
			private void hideAds() {
				...
				Toast.makeText(QAJSONFeedActivity.this, " Lucky Day No Ads for you", Toast.LENGTH_SHORT).show();
			}
		});
	...
	public class FeedAdapter extends RecyclerView.Adapter<FeedAdapter.ViewHolder>
	{
		...
		public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
		{
			...
			public void onClick(View view)
			{
				...
				Intent i=new Intent(QAJSONFeedActivity.this, ViewerActivity.class);
		...
		//				StartAppAd.showAd(getBaseContext());
			...
			}).ShowInterstitial(QAJSONFeedActivity.this, true);
		}
	...
	private void showNoInternet() {
		...
		button.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View p1) {
				//dialog.dismiss();
				Intent i = new Intent(QAJSONFeedActivity.this, SplashActivity.class);
				startActivity(i);
			}});
	}}
