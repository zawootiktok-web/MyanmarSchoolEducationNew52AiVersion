...
public abstract class TextIndexActivity extends AppCompatActivity {
//    public StartAppAd rewardedVideo = new StartAppAd(this);
    ...
    private BroadcastReceiver messageStatusReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (show) {
                ...
                Toast.makeText(TextIndexActivity.this, message, Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tbookindex_main);
...
//
//        // Initialize AudienceNetwork
//        audienceNetwork = new AudienceNetwork(this)
//                .init()
//                .setBannerId("IMG_16_9_APP_INSTALL#YOUR_PLACEMENT_ID") // Replace with your actual Banner Ad ID
//                .setInterstitialId("VID_HD_16_9_15S_APP_INSTALL#YOUR_PLACEMENT_ID") // Replace with your actual Interstitial Ad ID
...
//        audienceNetwork = new AudienceNetwork(this)
//                .init()
////                .setBannerId("YOUR_BANNER_AD_ID") // Replace with your Facebook Audience Network Banner Ad ID
////                .setInterstitialId("YOUR_INTERSTITIAL_AD_ID") // Replace with your Facebook Audience Network Interstitial Ad ID
//                .setBannerId("IMG_16_9_APP_INSTALL#YOUR_PLACEMENT_ID") // Replace with your actual Banner Ad ID
//                .setInterstitialId("VID_HD_16_9_15S_APP_INSTALL#YOUR_PLACEMENT_ID") // Replace with your actual Interstitial Ad ID
//
//                .setBannerLayoutId(R.id.ad_container) // Banner Ad Layout ID from XML
//                .setBannerStatus(true) // Enable Banner Ads
//                .setFullScreenStatus(true) // Enable Interstitial Ads
//                .build();
...
// Initialize BlogspotAPIManager
        ...
        //Admob.setBanner(findViewById(R.id.ad_view),TextIndexActivity.this);
//        adView = (AdView)
...
//        adView.loadAd(adRequest);
        ...
        // SDK Initialize
        Admob.loadInterstitialAds(TextIndexActivity.this);
//        Admob.loadRewordedAds(TextIndexActivity.this);
...
//                Intent intent=new Intent(TextIndexActivity.this,TextBookAll.class);
...
//        });
                ...
                }).ShowInterstitial(TextIndexActivity.this, true);
            }
...
//                startActivity(i);
            ...
            private void hideAds() {
              ...
              //  Toast.makeText(TextIndexActivity.this, " Lucky Day No Ads for you", Toast.LENGTH_SHORT).show();
            }
        });
...
//                    public void onDismiss() {
            ...
            private void launchNewBookActivity() {
                ...
                Intent i = new Intent(TextIndexActivity.this, NewBookActivity.class);
...
//            }).ShowInterstitial(TextIndexActivity.this, true);
    ...
    private void changeFont() {
        ...
        try {
            ...
            Toast.makeText(TextIndexActivity.this,
        ...
        private void showNoInternet () {
            ...
            button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View p1) {
                    ...
                    //dialog.dismiss();
                    Intent i = new Intent(TextIndexActivity.this, SplashActivity.class);
                    startActivity(i);
                }
            });
        }
