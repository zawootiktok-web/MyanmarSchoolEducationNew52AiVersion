...
public abstract class SIndexActivity extends AppCompatActivity

{
	...
	private BroadcastReceiver messageStatusReceiver = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (show) {
				...
				Toast.makeText(SIndexActivity.this, message, Toast.LENGTH_SHORT).show();
			}
		}
	};
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.sindex_main);
...
//                startActivity(i);
			...
			private void hideAds() {
				...
				//Toast.makeText(SIndexActivity.this, " Lucky Day No Ads for you", Toast.LENGTH_SHORT).show();
			}
		});
...
//                startActivity(i);
		...
		/*AdRequest adRequest = new AdRequest.Builder().build();
		 ...
		 interstitial = new InterstitialAd(IndexActivity.this);
		...
		//AdsUnit.INTERSTITIAL = "@string/admob_interstitial_id";
...
// SDK Initialize
		//Admob.loadInterstitialAds(SIndexActivity.this);
//		Admob.loadRewordedAds(SIndexActivity.this);
...
//					Intent i=new Intent(SIndexActivity.this,Main5.class);
//					startActivity(i);
//				}
//			});
				...
				}).ShowInterstitial(SIndexActivity.this, true);
			};});
...
try {
		...
		private void launchNewBookActivity() {
					Intent i=new Intent(SIndexActivity.this,NewBookActivity.class);
...
//				}
	...
	private void changeFont()
	{
		...
		try{
			...
			Toast.makeText(SIndexActivity.this,
...
//				dialog.dismiss();
				Intent i = new Intent(SIndexActivity.this, SplashActivity.class);
				startActivity(i);
			}});
	}}
