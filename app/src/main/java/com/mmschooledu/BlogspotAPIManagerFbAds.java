...
public class BlogspotAPIManagerFbAds {

    private static final String TAG = "BlogspotAPIManagerStartAdsNew";
    private static final String BLOGSPOT_JSON_URL = "https://myanmarschooleducationfbads.blogspot.com/feeds/posts/default?alt=json";

    private Context context;
    private RequestQueue requestQueue;

    public BlogspotAPIManagerFbAds(Context context) {
