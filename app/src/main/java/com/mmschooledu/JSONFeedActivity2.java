...
public abstract class JSONFeedActivity2 extends AppCompatActivity {
    ...
    private BroadcastReceiver messageStatusReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (show) {
                ...
                Toast.makeText(JSONFeedActivity2.this, message, Toast.LENGTH_SHORT).show();
            }
        }
    };
    @Override
...
//                startActivity(i);
            ...
            private void hideAds() {
                ...
                Toast.makeText(JSONFeedActivity2.this, " Lucky Day No Ads for you", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        Admob.loadInterstitialAds(JSONFeedActivity2.this);
//        Admob.loadRewordedAds(JSONFeedActivity2.this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.main_menushop, menu);
            ...
            public void onClick(View view) {
                new Admob(new onDismiss() {
                    ...
                    public void onDismiss() {
                        ...
                        Intent i = new Intent(JSONFeedActivity2.this, ViewerActivity.class);
...
//                        StartAppAd.showAd(getBaseContext());
                ...
                }).ShowInterstitial(JSONFeedActivity2.this, true);
            }
    ...
    private void showNoInternet () {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View p1) {
                ...
                //dialog.dismiss();
                Intent i = new Intent(JSONFeedActivity2.this, SplashActivity.class);
                startActivity(i);
            }
        });
    }
