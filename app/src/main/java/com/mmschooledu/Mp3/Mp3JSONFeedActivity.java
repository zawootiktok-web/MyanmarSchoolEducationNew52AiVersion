...
import com.mmschooledu.BlogspotAPIManagerFbAds2;
...
import com.mmschooledu.Viewer.VideoViewerActivity;
...
public abstract class Mp3JSONFeedActivity extends AppCompatActivity
{
    ...
    private BroadcastReceiver messageStatusReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (show) {
                ...
                Toast.makeText(Mp3JSONFeedActivity.this, message, Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        Admob.loadInterstitialAds(Mp3JSONFeedActivity.this);
//        Admob.loadRewordedAds(Mp3JSONFeedActivity.this);
        Admob.loadRewardedInterstitialAds(Mp3JSONFeedActivity.this);
...
//                startActivity(i);
            ...
            private void hideAds() {
                ...
                Toast.makeText(Mp3JSONFeedActivity.this, " Lucky Day No Ads for you", Toast.LENGTH_SHORT).show();
            }
        });
...
//                startActivity(i);
	...
	/*private String getFromPrefs(String currentLink)
	 {
    ...
    public class FeedAdapter extends RecyclerView.Adapter<FeedAdapter.ViewHolder>
    {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener
        {
            ...
            {
                Intent i=new Intent(Mp3JSONFeedActivity.this, VideoViewerActivity.class);
               // Intent i=new Intent(VideoJSONFeedActivity.this,MoviesDetailActivity.class);
