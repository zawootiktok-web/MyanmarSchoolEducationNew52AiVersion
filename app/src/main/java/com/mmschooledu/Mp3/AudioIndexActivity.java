...
public abstract class AudioIndexActivity extends AppCompatActivity
{
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        if(item.getItemId()==R.id.menu_font){
            ...
            Intent i=new Intent(AudioIndexActivity.this,Mp3MainActivity.class);
            startActivity(i);
        //refresh();
    }
...
//
                new Admob(new onDismiss() {
                    ...
                    public void onDismiss() {
                        ...
                        Intent i=new Intent(AudioIndexActivity.this, NewAudioActivity.class);
                ...
                }).ShowInterstitial(AudioIndexActivity.this, true);
            }
