...
public abstract class AudioJSONFeedActivity extends AppCompatActivity
{
    ...
    private BroadcastReceiver messageStatusReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (show) {
                ...
                Toast.makeText(AudioJSONFeedActivity.this, message, Toast.LENGTH_SHORT).show();
            }
        }
    };
...
//                startActivity(i);
            ...
            private void hideAds() {
                ...
                Toast.makeText(AudioJSONFeedActivity.this, " Lucky Day No Ads for you", Toast.LENGTH_SHORT).show();
            }
        });
...
//
                ...
                Intent i=new Intent(AudioJSONFeedActivity.this, AudioListViewActivity.class);
               ...
               //StartAppAd.showAd(getBaseContext());
                ...
                }).ShowInterstitial(AudioJSONFeedActivity.this, true);
            }
