...
public class SpecialGrammarActivity2 extends AppCompatActivity
    ...
    String mainUrl="https://uk.fims.org.pK/";
...
//        adView.loadAd(adRequest);
    ...
    public void newToast(String message){
        Toast.makeText(SpecialGrammarActivity2.this,message,Toast.LENGTH_LONG).show();
    }
        ...
        protected void onPostExecute(String result)
        {
            ...
            gridView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
                ...
                public void onItemClick(AdapterView<?> p1, View p2, int p3, long p4)
                {
                    ...
                    Intent i=new Intent(SpecialGrammarActivity2.this,SpecialBookDetailActivity.class);
    ...
    {
        getMenuInflater().inflate(R.menu.search_menu_grammer2,menu);
    ...
    { int id = item.getItemId();
        ...
        if(item.getItemId()==R.id.home2){
            ...
            e="div.elementor-post__card";
            a="h2";
            mainUrl="https://uk.fims.org.pk/all-pdf-books/";
            loadWeblink(mainUrl);
            btnNext.setVisibility(View.VISIBLE);
            btnPrev.setVisibility(View.VISIBLE);
            ...
            e="div.elementor-post__card";
            a="h2";
            mainUrl="https://uk.fims.org.pk/category/english-books/";
            loadWeblink(mainUrl);
          //  loadWeblink(mainUrl+"category/english-books/");
            ...
            e="div.elementor-post__card";
            a="h2";
            mainUrl="https://uk.fims.org.pk/category/english-grammmar/";
            loadWeblink(mainUrl);
            btnNext.setVisibility(View.VISIBLE);
            btnPrev.setVisibility(View.VISIBLE);
            ...
            e="div.elementor-post__card";
            a="h2";
            mainUrl="https://uk.fims.org.pk/category/english-vocabulary/";
            loadWeblink(mainUrl);
            btnNext.setVisibility(View.VISIBLE);
            btnPrev.setVisibility(View.VISIBLE);
            ...
            e="div.elementor-post__card";
            a="h2";
            mainUrl="https://uk.fims.org.pk/category/jolly-phonics/";
            loadWeblink(mainUrl);
            btnNext.setVisibility(View.VISIBLE);
            btnPrev.setVisibility(View.VISIBLE);
        }
