...
public class XDownloader {
    ...
    public void download(XModel xModel){
        try {
            ...
            Date now = new Date();
            String file = formatter.format(now) + "_xStreamPlayer.mp4";

            if (!new File(mBaseFolderPath).exists()) {
                new File(mBaseFolderPath).mkdir();
            }
           //String mFilePath = "file://" + mBaseFolderPath + file;
          ...
          // String mFilePath = "file://" + mBaseFolderPath + file;
            ...
            Toast.makeText(activity, "Starting Download : " + file, Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
