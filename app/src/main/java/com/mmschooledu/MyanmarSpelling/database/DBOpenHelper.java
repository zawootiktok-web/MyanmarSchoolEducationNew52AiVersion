package com.mmschooledu.MyanmarSpelling.database;
...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "mmspelling.db";
    ...
    public Cursor getStoryTitles2(int storyTypeId2) {
        // Adjusted query with a placeholder for parameter binding
        String query = "SELECT * FROM story_myanmar WHERE story_type_id = ?";
        // Return cursor
        return mDatabase.rawQuery(query, new String[]{String.valueOf(storyTypeId2)});
    }
