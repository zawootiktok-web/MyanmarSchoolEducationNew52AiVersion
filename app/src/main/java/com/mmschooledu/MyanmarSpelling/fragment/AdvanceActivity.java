...
public class AdvanceActivity extends AppCompatActivity {
    ...
    private com.mmschooledu.MyanmarSpelling.fragment.DatabaseHelper dbHelper;
    ...
    private void showPauseDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(AdvanceActivity.this, R.style.TransparentDialog);
    ...
    private void showGameOverDialog() {
        ...
        TextView scoreView = dialogView.findViewById(R.id.newscore);
...
//    private int currentScore = 0;
//    private int advanceBestScore = 0;
//    private boolean isPaused = false;
//    private boolean isExiting = false;
//
...
//        setContentView(R.layout.activity_game);
//
//        // โหลดคะแนนสูงสุดสำหรับ
//        SharedPreferences preferences = getSharedPreferences("WordWizPrefs", MODE_PRIVATE);
//        advanceBestScore = preferences.getInt("best_score_advance", 0);
//
//        // เชื่อมฐานข้อมูล
//        dbHelper = new DatabaseHelper(this);
//
...
//        }
//
//        // บันทึกคะแนนสูงสุดของ Advance Mode
//        SharedPreferences.Editor editor = getSharedPreferences("WordWizPrefs", MODE_PRIVATE).edit();
//        if (currentScore > advanceBestScore) {
//            advanceBestScore = currentScore;
//            editor.putInt("best_score_advance", advanceBestScore);
//        }
//        editor.apply();
//
//        showGameOverDialog();
...
//
//        scoreView.setText(String.valueOf(currentScore));
//        bestScoreView.setText(String.valueOf(advanceBestScore));
//
////        restartButton.setOnClickListener(v -> {
////            resetGameState();
////            Intent restartIntent = new Intent(AdvanceActivity.this, AdvanceActivity.class);
...
////            Intent homeIntent = new Intent(AdvanceActivity.this, QuizFragment.class);
